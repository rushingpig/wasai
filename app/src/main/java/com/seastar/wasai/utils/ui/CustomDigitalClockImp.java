...
/**
 * Created by Jamie on 2015/7/22.
 */
public class CustomDigitalClockImp extends DigitalClock {
    Calendar mCalendar;
    ...
    public CustomDigitalClockImp(Context context) {
        super(context);
        initClock(context);
    }

    public CustomDigitalClockImp(Context context, AttributeSet attrs) {
        super(context, attrs);
        initClock(context);
    }
