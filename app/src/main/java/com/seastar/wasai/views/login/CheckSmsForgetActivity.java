...
public class CheckSmsForgetActivity extends CanBeClosedActivity {
    String TAG = "CheckSmsForgetActivity";
    TextView txtsmstip2;
    EditText edit_sms;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checksmsforget);
        ...
        mMainHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                Log.v(TAG, "main get msg now !para1=" + para1);

                if (para1 == 0) {
                    waiting.showWaitingDlg(false);
                    Intent intent = new Intent();
                    intent.putExtra("MOB", "" + para_mob);
                    intent.putExtra("UUID", "" + para_uuid);
                    intent.setClass(CheckSmsForgetActivity.this, SetPasswordForgetActivity.class);
