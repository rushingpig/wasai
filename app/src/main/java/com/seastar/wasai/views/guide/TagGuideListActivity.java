...
/**
 * @author 杨腾
 * @ClassName: TagGuideListActivity
 * @Description: 标签导购列表
 * @date 2015年4月25日 下午3:26:52
 */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPullRefreshListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                CommonUtil.forwardToGuideDetail(TagGuideListActivity.this, guide);
            }
        });
        ...
        Response.Listener<JSONObject> sucessListener = new MyReqSucessListener() {
            ...
            public void doResponse(String dataJsonStr) {
                if (dataJsonStr != null) {
                    ...
                    if (!isRefresh) {
                        Toast.makeText(TagGuideListActivity.this, ToastMessage.NOT_FOUND_GUIDE_LIST, Toast.LENGTH_SHORT).show();
                    } else {
                        guideList.clear();
                        guideListAdapter.notifyDataSetChanged();
