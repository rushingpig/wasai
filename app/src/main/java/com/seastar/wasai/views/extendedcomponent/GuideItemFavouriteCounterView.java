 ...
 */
public class GuideItemFavouriteCounterView extends LinearLayout {
	private ImageView imageView;
	private TextView textView;

	public GuideItemFavouriteCounterView(Context context) {
		super(context);
	}

	public GuideItemFavouriteCounterView(Context context, AttributeSet attrs) {
		super(context, attrs);
		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		inflater.inflate(R.layout.guide_item_favorite_counter_view, this);
