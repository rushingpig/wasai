...
package com.seastar.wasai.views.astuetz;
 ...
 * @Description:
 * @date 2015年4月9日 下午5:25:26
 */
public class SearchPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public SearchPagerSlidingTabStrip(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SearchPagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setTabText(int position, String txt) {
