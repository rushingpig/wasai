...
public class ActWithoutShareWebActivity extends BaseActivity implements OnClickListener {
        ...
        Response.Listener<JSONObject> sucessListener = new MyReqSucessListener() {
            ...
            public void doResponse(String dataJsonStr) {
                if (dataJsonStr != null) {
                    ...
                    ActWithoutShareWebActivity.this.act = act;
    ...
    class JavaScriptMethods{
        ...
        public void login() {
            ...
            if (currentTime - lastClickTime > 1000) {
                Context context = ActWithoutShareWebActivity.this;
        ...
        public void forwardToProduct(String itemId) {
            ...
            if (currentTime - lastClickTime > 1000 && itemId != null) {
                ...
                CommonUtil.forwardToDetailPage(ActWithoutShareWebActivity.this, product);
            }
            lastClickTime = currentTime;
        }
        ...
        public void goToArticle(String articleId, int type) {
            ...
            if (currentTime - lastClickTime > 1000) {
                ...
                Intent intent = new Intent(ActWithoutShareWebActivity.this, MyApplication.getTemplate(objType.getTemplateId()));
                Bundle bundle = new Bundle();
                bundle.putLong("guideId", Long.parseLong(articleId));
                bundle.putString("pageTitle", objType.getTitle());
                intent.putExtras(bundle);
                ActWithoutShareWebActivity.this.startActivity(intent);
            }
            lastClickTime = currentTime;
        }
    }
